...
<body>
    ...
    <footer class=" text-white pb-5 pt-4 mt-2">

        <div class="bg-black col-12 text-md-start">
            <div class="row text-sm-center text-md-start">

                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    <h5 class="text-uppercase text-warning mb-4">Lunar Arcade</h5>
                    <p> &hercon;Here this is the rest room on Lunar ! We are the Lunar Arcade&trade; 
                        Relax mind & choose what is your Truily dessire&hellip;&hearts;&heartsuit;
                    </p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy; 2024 Lunar Arcade All Rights Reserved.</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-house-fill"></i> 07/127, Menikhinna, Kandy</p>
                    <p><i class="bi bi-at"></i> lunararcade@gmail.com</p>
                    <p><i class="bi bi-telephone-fill"></i> +94 70 728 728</p>
                    <p><i class="bi bi-printer-fill"></i> +94 81 675 675</p>
